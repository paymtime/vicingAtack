...
pygame.display.set_caption("VicingAtac")
...
bg = pygame.image.load('img/hell.png')
char = pygame.image.load('img/L1.png')
...
music = pygame.mixer.music.load('music (2).mp3')
...
man = player(400, 250, 64, 64)
goblin = enemy(100, 250, 64, 64, 450)
shootLoop = 0
bullets = []
run = True
while run:
